      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md relative z-10">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            {isLoading ? "Creating account..." : "Continue with Apple"}
          </Button>
        </div>
          ...
          <div>
            ...
            <div className="mt-1 relative">
              <Input
                ...
                className={`${showErrors && displayNameError ? 'border-red-500 focus:ring-red-500' : ''}`}
                disabled={isLoading}
              />
              {showErrors && displayNameError && (
          ...
          <div>
            ...
            <div className="mt-1 relative">
              <Input
                ...
                className={`${showErrors && confirmPasswordError ? 'border-red-500 focus:ring-red-500' : ''}`}
                disabled={isLoading}
              />
