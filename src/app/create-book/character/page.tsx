...
import { getCharactersForUniverse, universeNames } from '@/lib/mockData'
...
export default function CharacterSelectionPage() {
  ...
  useEffect(() => {
    if (universe) {
      const chars = getCharactersForUniverse(universe)
      setCharacters(chars)
    }
  }, [universe])
                ...
                <div className="flex-col justify-start items-start gap-2 inline-flex">
                  ...
                  <div className="text-sm leading-5 max-w-[834px] text-neutral-800 text-opacity-70 text-left max-lg:hidden">
                    {universe === 'amulet' 
                      ...
                      : `Choose your hero for this ${universeName} adventure.`
                    }
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      <div className={`flex flex-col justify-center w-full text-sm rounded-xl bg-gray-50 border ${
                        character.isSpecial ? 'border-[#eebf17]' : 'border-gray-200'
